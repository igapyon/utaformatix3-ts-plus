...
readonly DEFAULT_UPSTREAM_DIR="upstream/mikuscore"
readonly DEFAULT_REPO_URL="https://github.com/igapyon/mikuscore.git"

usage() {
  cat <<'EOF'
Usage:
  ./scripts/sync-upstream-mikuscore.sh <ref> [repo_url] [upstream_dir]

Examples:
  ./scripts/sync-upstream-mikuscore.sh main
  ./scripts/sync-upstream-mikuscore.sh v0.1.0
  ./scripts/sync-upstream-mikuscore.sh 0123456789abcdef0123456789abcdef01234567
  ./scripts/sync-upstream-mikuscore.sh main https://github.com/igapyon/mikuscore.git upstream/mikuscore
EOF
}
...
echo "  git commit -m \"chore: sync mikuscore upstream to $RESOLVED_COMMIT\""
